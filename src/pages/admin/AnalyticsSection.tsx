...
export function AnalyticsSection() {
  ...
  return (
    <div>
      ...
      <div className="bg-gradient-to-r from-orange-600 to-orange-700 rounded-lg shadow-lg p-8 text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            ...
            <div className="text-orange-100">Новых заказов</div>
          </div>
          <div>
            <div className="text-4xl font-bold mb-2">
              {stats.recentOrders.revenue.toLocaleString('ru-RU', { maximumFractionDigits: 0 })} ₽
            </div>
            <div className="text-orange-100">Выручка за период</div>
          </div>
        </div>
      </div>
    </div>
